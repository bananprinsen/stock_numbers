...
Stock Numbers is a application for presenting accounting numbers in a formatted matter. Current version supports JSON.
...
## Development environment and release process
 ...
 - create virtualenv with Flask and Stock Numbers installed into it (latter is installed in
...
install it (`pip install stock_numbers.tar.gz`), ensure that configuration file exists and
`STOCK_NUMBERS_SETTINGS` environment variable points to it, ensure that user has access to the
